...
// Engine-backed SDK tests: they open the personal-edition default (sqlite)
// backend, so they are excluded from enterprise builds. The backend-agnostic
// registry/config tests stay in ladym_test.go and run in both editions.
